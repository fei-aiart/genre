...
from model.generator.Unet_base import SPADEUNet, SPADEUNet_YPar
...
from myutils.image_util import par_tensor2pix
...
class SAND_pix_BaseLine(pl.LightningModule):
    ...
    def train_dataloader(self):  # trainset
        ...
        loader = DataLoader(dataset=dataset, shuffle=True, batch_size=self.opt.bsize, pin_memory=True)
        return loader
