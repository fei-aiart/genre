from data.data_ref_path import Data_Dictionary
...
class BaseOptions(ModelOption):
    def initialize(self, parser):
        ...
        parser.add_argument('--gpu', type=str, default='2', help='number of using gpus')
...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        # Lsem
        parser.add_argument('--lambda_par', type=float, default=4, help='weight for paring matching loss')  # 4
        # Lgeo
...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--data_dir', type=str, default='./dataset/test_single', help='saves results here.')
        parser.add_argument('--checkpoint_dir', type=str, default='./checkpoint/pencil_drawing_checkpoint.ckpt', help='saves results here.')
